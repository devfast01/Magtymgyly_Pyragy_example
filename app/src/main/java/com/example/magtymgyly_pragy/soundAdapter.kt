...
class soundAdapter    // Parameterized constructor of this class to initialize tutorialList
    ( // Main-list item titles will be stored here
    private val tutorialList: ArrayList<soundModel>
) :
    ...
    interface OnClickListener {
        fun onClick(position: Int, model: soundModel)
    }
